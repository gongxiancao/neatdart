...
class FeedForwardNetwork implements NeuralNetwork {
  ...
  static FeedForwardNetwork create({
    ...
    final layers = Graphs.feedForwardLayers(inputs: config.genome.inputKeys, outputs: config.genome.outputKeys, connections: connections);
    ...
    for (final layer in layers) {
      for (final node in layer) {
        ...
        final aggregationFunction = config.genome.aggregationFunctionDefs[ng.aggregation]!;
    ...
    return FeedForwardNetwork(inputNodes: config.genome.inputKeys, outputNodes: config.genome.outputKeys, nodeEvals: nodeEvals);
  }
